          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            ...
            <label className="flex gap-2 cursor-pointer">
              <input
                ...
                value={"Hats"}
                onChange={toggleSubCategory}
                checked={subCategory.includes("Hats")}
              />
              Hats
            </label>
            <label className="flex gap-2 cursor-pointer">
              <input
                ...
                value={"Jewelry"}
                onChange={toggleSubCategory}
                checked={subCategory.includes("Jewelry")}
              />
              Jewelry
            </label>
            <label className="flex gap-2 cursor-pointer">
              <input
                ...
                value={"Shoes"}
                onChange={toggleSubCategory}
                checked={subCategory.includes("Shoes")}
              />
              Shoes
            </label>
            <label className="flex gap-2 cursor-pointer">
              <input
                ...
                value={"Sandals"}
                onChange={toggleSubCategory}
                checked={subCategory.includes("Sandals")}
              />
              Sandals
            </label>
            <label className="flex gap-2 cursor-pointer">
              <input
                ...
                value={"Handbags"}
                onChange={toggleSubCategory}
                checked={subCategory.includes("Handbags")}
              />
              Handbags
            </label>
            <label className="flex gap-2 cursor-pointer">
              <input
                ...
                value={"Backpacks"}
                onChange={toggleSubCategory}
                checked={subCategory.includes("Backpacks")}
              />
              Backpacks
            </label>
          </div>
